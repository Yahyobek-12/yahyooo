...
export { default as HSec2 } from './Sections/Home/HSec2'
export { default as HSec3 } from './Sections/Home/HSec3'
export { default as HSec4 } from './Sections/Home/HSec4'

// export sections for About page
export { default as ASec1 } from './Sections/About/ASec1'