...
const HSec3 = () => {
  return (
    <div className="w-[100%] lg:h-[100vh] md:h-[80vh] h-[100vh] lg:py-10 py-4 lg:px-10 px-4 lg:mt-0 md:mt-80 ss:mt-40 mt-4">
       <div className='w-[100%] h-[100%] rounded-lg relative shadow-2xl community md:flex block items-center justify-around bg-white py-2 px-4'>
        <div>
          ...
          <Link to='/' target='_blank' className='py-2 px-8 bg-gradient-to-tr from-black to-slate-500 text-lg rounded-lg text-white border-b-2 border-black hover:opacity-85'>Join now</Link>
        </div>
