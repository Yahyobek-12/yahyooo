  ...
  return (
    <div className="min-h-screen flex flex-col">
      <div className="flex-grow">
        <div className="w-[100%] sm:h-[50vh] h-[40vh] flex items-center justify-center">
        ...
        <div className='w-[100%] bg-white lg:px-24 md:px-12 px-4 py-8 border-t-2 border-gray-300 rounded-t-[50px]'>
          ...
          <p className='mt-4 sm:text-[20px] ss:text-[18px] text-[17px]'>
          ...
          <div className='w-[100%] sm:h-[200px] h-[120px] bg-gray-200 rounded-lg mt-8 border-2 border-blue-500 border-dashed flex items-center justify-center hover:scale-[99%]'>
            <Link to='' target='_blank' className='sm:text-3xl ss:text-xl text-md flex items-center'>
              You can find more about me <PiShareFatLight className='ml-4 py-[5px] px-[4xp] bg-blue-500 text-white rounded-full' />
            </Link>
          </div>
          ...
          <Link to='/' target='_blank' className='py-3 px-4 bg-gradient-to-bl from-black to-slate-500 text-white rounded-lg border-b-2 border-black hover:opacity-85'>See CV</Link>
        </div>
      </div>
    </div>
  );
